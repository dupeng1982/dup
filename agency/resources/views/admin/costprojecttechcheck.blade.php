...
@section('admin-title')
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">造价项目技术审核</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('admin/index') }}">首页</a></li>
                <li class="breadcrumb-item active">造价项目技术审核</li>
            </ol>
        </div>
...
@section('admin-js')
    ...
    <script>
        $(function () {
            ...
            function refresh() {
                $('#project_table').bootstrapTable('refresh', {url: 'getCostProjectDCheckList'});
            }
