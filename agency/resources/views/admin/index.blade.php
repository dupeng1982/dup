...
<div id="main-wrapper">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="/admin/assets/images/users/1.jpg" alt="user" class="profile-pic"/></a>
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            <!-- User profile -->
            <div class="user-profile" style="background: url(/admin/assets/images/background/user-info.jpg) no-repeat;">
                <!-- User profile image -->
                <div class="profile-img"><img src="/admin/assets/images/users/profile.png" alt="user"/></div>
                <!-- User profile text-->
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="/admin/minisidebar/index.html">Minisidebar</a></li>
                            <li><a href="/admin/horizontal/index2.html">Horizontal</a></li>
                            <li><a href="/admin/dark/index3.html">Dark Version</a></li>
                            <li><a href="/admin/material-rtl/index4.html">RTL Version</a></li>
